...
#angles=[(0,1,0,.5), (0.8,.4,.8,.2), (.5,.6,.7,.8)]  # q1
#angles=[(.5,1,2,.5), (.8,.4,.8,.2), (.5,.8,.7,.5)]  # q2
angles=[(.5,1,0,.5), (.8,.4,.8,.2), (.5,.8,.7,.5)]  # q3
#angles=[
#(0.000, 0.894, 0.000, 0.447),
#(0.658, 0.329, 0.658, 0.164),
#(0.379, 0.455, 0.531, 0.606),
#[0.213, 0.426, 0.853, 0.213],
#[0.658, 0.329, 0.658, 0.164],
#[0.392, 0.627, 0.548, 0.392]
#[0.408, 0.816, 0.000, 0.408],
#[0.658, 0.329, 0.658, 0.164],
#[0.392, 0.627, 0.548, 0.392]
#]
#normalised=[]
#for a in angles:
#    s=sum(map(lambda _: _**2, a))
#    n=map(lambda _: '%.3f' % (_/s**.5), a)
#    normalised.append(n)
#normalised=numpy.matrix(normalised)
#print normalised
#print normalised.transpose()
#sys.exit(0)
