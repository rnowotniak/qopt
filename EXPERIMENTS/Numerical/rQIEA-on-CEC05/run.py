#!/usr/bin/python
#
# Ten skrypt ma na celu odtworzyc Table 18 z Gexiang's Survey
#
# Ten skrypt w zasadzie powinien byc wzorcowym przykladem wykorzystania frameworka
#
...
from qopt.algorithms.rQIEA import rQIEA
