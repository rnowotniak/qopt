...
_FUNCTIONS_DATA =  (
        ...
        (     (-5, 5),   10, (     (-5, 5),      (-5, 5)), 60,          1e-1 ), # f20
        (     (-5, 5),  360, (     (-5, 5),      (-5, 5)), 60,          1e-1 ), # f21
        (     (-5, 5),  360, (     (-5, 5),      (-5, 5)), 60,          1e-1 ), # f22
        (     (-5, 5),  360, (     (-5, 5),      (-5, 5)), 60,          1e-1 ), # f23
        (     (-5, 5),  260, (     (-5, 5),      (-5, 5)), 60,          1e-1 ), # f24
        (      (2, 5),  260, (     (-5, 5),      (-5, 5)), 60,          1e-1 )  # f25
        )
