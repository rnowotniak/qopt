% -----------------------------------------------------------------
% Cuckoo algorithm by Xin-She Yang and S. Deb                     %
% Programmed by Xin-She Yang at Cambridge University              %
% Copyright by Xin-She Yang at xy227@cam.ac.uk                    %
% Programming dates: Nov 2008 to June 2009                        %
% Last revised: July 2009   (simplified version for demo only)    %
% -----------------------------------------------------------------
% Paper Citation Details:
% X.-S. Yang, S. Deb, Cuckoo search via Levy flights,
% in: Proc. of World Congress on Nature & Biologically Inspired
% Computing (NaBIC 2009), December 2009, India,
% IEEE Publications, USA,  pp. 210-214 (2009).
% ----------------------------------------------------------------%
% This demo program only implements the basic Cuckoo Search (CS)  %
% The pseudo code was given sequentially (select a cuckoo etc),   %
% but the implementation uses Matlab's vector capability, which   %
% results in neater codes and shorter running time.               % 
...
% d-dimensional sphere function sum_j=1^d (u_j-1)^2. 
 z=sum((u-1).^2);
% Rosenbrock's function (slightly different)
% z=(u(1)-1)^2+100*(u(2)-u(1)^2)^2+100*(u(3)-u(2)^2)^2+100*(u(4)-u(3)^2)^2+100*(u(5)-1)^2;